...
export default () => {
  ...
  return (
    <Container>
      ...
      <ViewTermsAndConditions>
        <TextTitle>TERMOS DE USO DO SITE E APLICATIVO CIT</TextTitle>
        <TextTerms>
          PRIMEIRA EDIÇÃO: 28/10/2022 1. TERMOS DE USO A CIT é uma solução para
          ...
          usuários da CIT e a empresa. Caso alguma parte dos Termos de Uso ou
          ...
          mensagem pelo formulário de contato ou e-mail. 2. SOBRE O WEBSITE CIT
          O website CIT serve exclusivamente como forma de divulgação dos
          serviços prestados pela empresa, possuindo conteúdo meramente
          informativo e ilustrando como funciona a soluçãa CIT, a empresa e seus
          ...
          vínculos comerciais entre a empresa CIT e os usuários do website.
          Sendo da sua vontade adquirir algum dos serviços ou produtos ofertados
          pela CIT dispomos de um formulário de contato online, onde você pode
          ...
          com a CIT para revender a solução em sua cidade ou estado, basta
          ...
          aplicativos e soluções CIT inicialmente você deverá preencher os
          ...
          cancelamento de conta nos aplicativos e serviços CIT, sem qualquer
          ...
          falha, você deverá comunicar de forma imediata à CIT sobre o ocorrido
          ...
          PELA CIT E SUAS FINALIDADES Além dos formulários citados anteriormente
          nesse documento, que são preenchidos pelo próprio Usuário, a CIT
          ...
          plataformas e aplicativos CIT: Para dispor do uso das soluções e
          serviços CIT todas as informações inseridas ativamente pelo Usuário
          ...
          e no Aplicativo. A CIT fará uso dessas informações para promover a
          divulgação de material publicitário referente à: oferta de
          oportunidades de negócios e franquias, promoções, eventos a serem
          feitos pela equipe ou por terceiros em nome da CIT, assuntos gerais
          ...
          pesquisa de satisfação. 5.2. Dados coletados automaticamente: A CIT
          ...
          estes, dentre outros. Para coletar essas informações e dados a CIT
          ...
          termos da Política de Privacidade CIT. Esses dados também poderão ser
          ...
          corretamente. 5.4. A CIT não trata dados de menores de 12 anos. Não
          ...
          as informações e textos dispostos no website e aplicativa CIT são de
          ...
          exclusiva da CIT e por esse motivo não é concedida qualquer licença ou
          ...
          controle da CIT. Isto não implica que a CIT endosse o conteúdo destes
          ou qualquer associação de seus fornecedores. O uso do nome “CIT”, do
          ...
          da CIT e estão protegidos pelas leis e tratados internacionais de
          ...
          a CIT não se responsabiliza por eventuais danos decorrentes da
          ...
          políticas aplicáveis aos sites de terceiros quando os visitar. A CIT
          ...
          serviços CIT. Qualquer intromissão, tentativa, ou atividade que viole
          ...
          indenização por eventuais danos causados. A CIT não se responsabiliza
          ...
          Serviços de Telecomunicação e Interfonia do Grupo CIT passam a vigorar
          ...
          dúvidas, insatisfação ou questões relativas as soluções CIT ou a esta
